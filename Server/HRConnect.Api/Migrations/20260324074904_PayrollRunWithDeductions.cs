...
{
  /// <inheritdoc />
  public partial class PayrollRunWithDeductions : Migration
  {
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      //Drop this older statutory table and make a new derived class for 
      // PayrollRecords
      migrationBuilder.DropTable(name: "TestEntities");
      migrationBuilder.DropTable(name: "StatutoryContributions");
