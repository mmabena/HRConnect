  ...
  public partial class EmployeePayrollEarningRelationsAndEmployeeDeductionRelation : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.Sql(@"
                IF NOT EXISTS ( SELECT 1 FROM PayrollEarnings WHERE PayrollEarningId = 'PRE001')
                  BEGIN
                      INSERT INTO PayrollEarnings (PayrollEarningId, CanProRata, IsActive, IsOnGoing, LongDescription, OvertimeHourMultiplier, ShortDescription, 
                      TaxCode, TaxPercentage, Taxable) VALUES ('PRE001', 1, 1, 1, 'Employee monthly salary', NULL, 'Basic salary', 3601, 100, 1 )
                  END
            ");
