...
namespace HRConnect.Api.Migrations
{
    ...
    [Migration("20260424172146_SalaryBenchmarksTq")]
    partial class SalaryBenchmarksTq
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRConnect.Api.Models.Benchmarking.SalaryBenchmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InternalJobGradeId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("Salary25th")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("Salary50th")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("Salary75th")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HRConnect.Api.Models.PayrollDeduction.FinalTaxDeduction", b =>
                {
                    b.HasBaseType("HRConnect.Api.Models.Payroll.PayrollRecord");
                    ...
                    b.Property<int>("MedicalAidChildren")
                        .HasColumnType("int");

                    b.Property<int>("MedicalAidDependants")
                        .HasColumnType("int");

                    b.Property<int>("MedicalAidMembers")
                        .HasColumnType("int");

                    b.Property<decimal>("MedicalTaxCredit")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HRConnect.Api.Models.Benchmarking.SalaryBenchmark", b =>
                {
                    b.HasOne("HRConnect.Api.Models.JobGrade", "JobGrade")
                        .WithMany()
                        .HasForeignKey("InternalJobGradeId")
