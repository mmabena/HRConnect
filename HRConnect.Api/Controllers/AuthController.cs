namespace HRConnect.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginDto loginDto)
        {
            ...
            if (!loginDto.Email.EndsWith("@singular.co.za", System.StringComparison.OrdinalIgnoreCase))
            ...
            {
                return BadRequest(new { errors = new[] { ex.Message } }); // dynamic, cannot be static
            }
